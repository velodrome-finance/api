...
from app.settings import CACHE, DEFAULT_TOKEN_ADDRESS, STABLE_TOKEN_ADDRESS, ROUTE_TOKENS
...
class Configuration(object):
    ...
    def on_get(self, req, resp):
        ...
        route_tokens = [Token.find(token.lower()) for token in ROUTE_TOKENS]
        ...
        resp.text = json.dumps(
            dict(
                data=[default_token._data, stable_token._data, *route_token_data],
                meta=dict(
                    tvl=tvl,
                    max_apr=max_apr,
